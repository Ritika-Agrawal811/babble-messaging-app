...
const DeleteChatConfirmModal: React.FC<ConfirmModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <section className='mx-2 my-4'>
                ...
                <div className='mt-6 flex justify-end gap-4 md:mt-0'>
...
export default DeleteChatConfirmModal
